...
export default {
    ...
    methods: {
        ...
        getUserData() {
            ...
            //         this.filedErrorMsg = true
            //     }
            //     else {
            //         this.filedErrorMsg = false
            //     }
            // }
            // !this.selectedRole ? this.radioBtnErrorMsg = true : this.radioBtnErrorMsg = false
            ...
            if (!this.filedErrorMsg && this.selectedRole) {
                ...
                service.methods.getData(this.selectedRole)
                    .then(res => {
                        ...
                        if (this.exist) {
                            console.log('this email has registered before');
                        }
                        else {
        ...
        // registerData() {
        //     this.selectedRole == 'admins' ? this.register(this.formData, this.selectedRole) : this.register(this.formData, 'users')
        // },
